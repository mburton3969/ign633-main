		...
		<div class="row display-flex">
			<div class="col col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12">
				<div class="landing-content">
					<h1>NOT A CHURCH,<br />BUT A MOVEMENT</h1>
					<p>As the church we are to bring Christ to the masses, not bring the masses to Christ.
					</p>
					<a href="#" class="btn btn-md btn-border c-white">PODCAST</a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col col-xl-10 m-auto col-lg-10 col-md-12 col-sm-12 col-12">
				<img class="main-img" src="assets/img/scale1.png" alt="screen">
			</div>
		</div>

		<img class="first-img1" alt="img" src="assets/img/scale2.png">
		<img class="second-img1" alt="img" src="assets/img/scale3.png">
		<img class="third-img1" alt="img" src="assets/img/scale4.png">
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
				<img src="assets/img/icon-fly.png" alt="screen">
			</div> 
...
<section class="medium-padding120">
	<div class="container">
		<div class="row">
			...
			<div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
				<img src="assets/img/image1.png" alt="screen">
			</div>
		</div>
	</div>
</section>
...
<section class="medium-padding120">
	<div class="container">
		<div class="row">
			<div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
				<img src="assets/img/image2.png" alt="screen">
			</div>
...
<section class="medium-padding120">
	<div class="container">
		<div class="row">
			...
			<div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
				<img src="assets/img/image3.png" alt="screen">
			</div>
		</div>
	</div>
</section>
...
<section class="medium-padding120 bg-section3 background-cover planer-animation">
					...
					<div class="ui-block swiper-slide">
						...
						<div class="crumina-module crumina-testimonial-item">
							...
							<div class="testimonial-item-content">
								...
								<div class="author-thumb">
									<img src="assets/img/avatar17.jpg" alt="author">
								</div>
	...
	<img src="assets/img/planer.png" alt="planer" class="planer">
</section>
...
<section class="medium-padding120">
	<div class="container">
		<div class="row">
			<div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
				<img src="assets/img/image4.png" alt="screen"> 
			</div>
...
<section class="medium-padding100 subscribe-animation scrollme bg-users">
	<div class="container">
		...
		<img src="assets/img/paper-plane.png" alt="plane" class="plane">
	</div>
</section>
	...
	<div class="modal-dialog window-popup registration-login-form-popup" role="document">
		<div class="modal-content">
			...
			<div class="modal-body" style="">
				<div class="registration-login-form" style="">
					<!-- Nav tabs -->
					...
					<!-- <div class="tab-content" style="">
						<div class="tab-pane active" id="home1" role="tabpanel" data-mh="log-tab" style="">
						...
						<div class="tab-pane" id="profile1" role="tabpanel" data-mh="log-tab" style="">
							...
							<form class="content">
								<div class="row">
									<div class="col col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
										...
										<a href="#" class="btn btn-lg bg-facebook full-width btn-icon-left"><svg class="svg-inline--fa fa-facebook-f fa-w-10" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="facebook-f" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" data-fa-i2svg=""><path fill="currentColor" d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z"></path></svg><!-- <i class="fab fa-facebook-f" aria-hidden="true"></i> Login with Facebook</a>

										<a href="#" class="btn btn-lg bg-twitter full-width btn-icon-left"><svg class="svg-inline--fa fa-twitter fa-w-16" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="twitter" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M459.37 151.716c.325 4.548.325 9.097.325 13.645 0 138.72-105.583 298.558-298.558 298.558-59.452 0-114.68-17.219-161.137-47.106 8.447.974 16.568 1.299 25.34 1.299 49.055 0 94.213-16.568 130.274-44.832-46.132-.975-84.792-31.188-98.112-72.772 6.498.974 12.995 1.624 19.818 1.624 9.421 0 18.843-1.3 27.614-3.573-48.081-9.747-84.143-51.98-84.143-102.985v-1.299c13.969 7.797 30.214 12.67 47.431 13.319-28.264-18.843-46.781-51.005-46.781-87.391 0-19.492 5.197-37.36 14.294-52.954 51.655 63.675 129.3 105.258 216.365 109.807-1.624-7.797-2.599-15.918-2.599-24.04 0-57.828 46.782-104.934 104.934-104.934 30.213 0 57.502 12.67 76.67 33.137 23.715-4.548 46.456-13.32 66.599-25.34-7.798 24.366-24.366 44.833-46.132 57.827 21.117-2.273 41.584-8.122 60.426-16.243-14.292 20.791-32.161 39.308-52.628 54.253z"></path></svg><!-- <i class="fab fa-twitter" aria-hidden="true"></i> Login with Twitter</a>
