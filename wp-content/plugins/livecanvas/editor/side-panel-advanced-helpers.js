$(document).ready(function ($) {
    ...
    $("#sidepanel").on("click", ".wpadmin-image-format-chooser a", function (event) {
        ...
        var img_alt = $(this).parent().attr("alt");
        current_section=$(this).closest("section");
        current_section.find(" input[attribute-name='src'], input[name='background-image']").val(img_url).change();
        current_section.find(" input[attribute-name='alt']").val(img_alt).change();
	...
	$('#sidepanel').on('change', 'input[name="unsplash-search-by-keyword"]', function (event) {
        ...
        var jqxhr = $.getJSON("https://api.unsplash.com/search/photos/?client_id=241722b04b93fb65e1514ad48c3e916f5399e7766e5fa0dba784e008b9866216&orientation=landscape&query="+$(this).val()+"&page="+current_page , function(a) {
            //console.log(a.results);
            var headingText='<small><p>'+a.total+' images found.  Page <b>'+current_page+' of '+a.total_pages+'</b></p>  </small>';
            html_li="";
            ...
            if ( current_page>1 )  prevButton="<button class='lc-unsplash-pagination-button lc-pagination-button  lcb' data-page='"+(current_page-1)+"' >&laquo; Previous<br>Page</button>"; else   prevButton="";    
            if (a.total_pages>current_page)  nextButton="<button class='lc-unsplash-pagination-button lc-pagination-button  lcb' data-page='"+(1+current_page)+"' >Next <br>Page &raquo;</button>"; else   nextButton="";
    ...
    $("#sidepanel").on("click", " .lc-unsplash-search-results img", function (event) {
        ...
        img_url=img_url.replace("w=1080","w=1080&h=768").replace("fit=max","fit=crop");
        current_section.find(" input[attribute-name='src'], input[name='background-image']").val(img_url).change();
        ...
        //var el=lc_clicked_page_element.closest('a');
        ...
        //    var bigImageUrl =  $(this).attr("data-src-regular");
    ...
    $("body").on("change", "#sidepanel section[item-type=image] *[attribute-name=src], #sidepanel section[item-type=background] *[name=background-image]",function(){
        if ($(this).val().includes("unsplash.com")) $(".imgix-fx").show(); else $(".imgix-fx").hide();
    });
